...
class ReplicatedChatServer:
    ...
    # In replicated_server.py - Improved start method
    def start(self):
        """Start the server."""
        try:
            ...
            if self.config.config["leader_id"] == self.config.server_id:  # Use config.server_id instead of server_id
    ...
    if args.join and args.leader:
        ...
        for attempt in range(max_attempts):
            try:
                ...
                # Serialize and send using proper format
